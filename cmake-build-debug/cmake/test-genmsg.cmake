...
set(MSG_I_FLAGS "-Itest:/home/eddy/catkin_sandbox/src/test/msg")
...
get_filename_component(_filename "/home/eddy/catkin_sandbox/src/test/msg/IntMsg.msg" NAME_WE)
add_custom_target(_test_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "test" "/home/eddy/catkin_sandbox/src/test/msg/IntMsg.msg" ""
)

get_filename_component(_filename "/home/eddy/catkin_sandbox/src/test/srv/Empty.srv" NAME_WE)
add_custom_target(_test_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "test" "/home/eddy/catkin_sandbox/src/test/srv/Empty.srv" ""
)
...
_generate_msg_cpp(test
  "/home/eddy/catkin_sandbox/src/test/msg/IntMsg.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(test
  "/home/eddy/catkin_sandbox/src/test/srv/Empty.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/test
)
