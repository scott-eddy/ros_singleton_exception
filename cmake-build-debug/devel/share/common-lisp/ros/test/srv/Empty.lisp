...
(cl:defmethod cl:initialize-instance :after ((m <Empty-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Empty-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<Empty-request> is deprecated: use test-srv:Empty-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Empty-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Empty-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<Empty-response> is deprecated: use test-srv:Empty-response instead.")))
