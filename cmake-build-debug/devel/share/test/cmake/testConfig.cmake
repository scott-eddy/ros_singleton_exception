...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/eddy/catkin_sandbox/src/test)
  set(test_DEVEL_PREFIX /home/eddy/catkin_sandbox/src/test/cmake-build-debug/devel)
...
if(NOT "/home/eddy/catkin_sandbox/src/test/cmake-build-debug/devel/include " STREQUAL " ")
  set(test_INCLUDE_DIRS "")
  set(_include_dirs "/home/eddy/catkin_sandbox/src/test/cmake-build-debug/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'eddy <eddy@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eddy/catkin_sandbox/src/test/${idir}'.  Ask the maintainer 'eddy <eddy@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/eddy/catkin_sandbox/src/test/cmake-build-debug/devel/lib;/home/eddy/catkin_sandbox/devel/lib;/home/eddy/OpenSource/ros_catkin_source/install_isolated/lib)
